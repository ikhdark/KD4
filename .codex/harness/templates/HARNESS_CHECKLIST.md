...
- [ ] Smallest sufficient workflow and artifact set chosen
...
- [ ] Root and scoped instructions plus any selected or applicable skill applied
      for implementation or repo-behavior work
