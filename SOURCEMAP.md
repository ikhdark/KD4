...
Tracked repository path snapshot: `count=5012 sha256=22f3027b1328c16247b28904a0a196a944021bd9b0cfac691005325678ef5611`.
...
<!-- BEGIN KD4 SOURCE OWNERS schema=2 manifest_sha256=f58979aeaf05fd589b539bd5b0387225d1ece6505a98101953729ba6141959f7 -->
...
| `completion-proof-certification` | `scripts/completion_proof.py`<br>`scripts/completion_proof_inventory_v2.py`<br>`codex-rs/validation-contracts`<br>`.codex/validation` | `scripts/completion_proof.py::main`<br>`scripts/completion_proof_inventory_v2.py::validate_frozen_test_inventory_v2`<br>`codex-rs/validation-contracts/src/inventory_v2.rs::FrozenTestInventoryV2` | `control_flow:calls` -> `path:scripts/completion_proof.py`<br>`callers_consumers:consumed_by` -> `path:codex-rs/core/src/completion_proof.rs`<br>`configuration:reads_config` -> `config:.codex/validation/completion-proof.toml`<br>+4 more | `semantic:canonical-command-gate-separation`<br>`compatibility:immutable-baseline-reconciliation`<br>`compatibility:cross-language-validation-contract-parity` | `completion-proof-source-owner-focused`<br>`completion-proof-runner-focused`<br>`inventory-v2-python-focused`<br>`inventory-v2-rust-focused` |
