...
<!-- BEGIN KD4 SOURCE OWNERS schema=1 manifest_sha256=f8cf95c3b56091a5f5550ab1824b8a8df5e8bef5d217b8d0ba1e13165d510015 -->
...
| `source-discovery` | `codex-rs/file-search/src`<br>`codex-rs/core/src/tools/handlers/source.rs`<br>`codex-rs/core/src/tools/handlers/source_spec.rs`<br>`codex-rs/core/src/tools/spec_plan.rs` | `codex-rs/file-search/src/task_locator.rs::locate_task`<br>`codex-rs/core/src/tools/handlers/source.rs::LocateTaskHandler` | `file-search-locator-focused`<br>`core-source-tools-focused` |
