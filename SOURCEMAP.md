...
Tracked repository path snapshot: `count=5161 sha256=e2aff46099364929574508fd63d1170b620aab38b83358dfa8fb5173bcde4ce2`.
...
<!-- BEGIN KD4 SOURCE OWNERS schema=2 manifest_sha256=15bb38dde59dfacbc344178ef57d5cdde3fbc7b8eeef3cd1b0bebc3f11ffddb5 -->
...
| `completion-proof-certification` | `scripts/completion_proof.py`<br>`scripts/completion_proof_inventory_v2.py`<br>`scripts/materialize_completion_proof_inventory_v2.py`<br>`codex-rs/validation-contracts`<br>`.codex/validation` | `scripts/completion_proof.py::main`<br>`scripts/completion_proof_inventory_v2.py::validate_frozen_test_inventory_v2`<br>`scripts/materialize_completion_proof_inventory_v2.py::main`<br>`codex-rs/validation-contracts/src/inventory_v2.rs::FrozenTestInventoryV2` | `control_flow:calls` -> `path:scripts/completion_proof.py`<br>`callers_consumers:consumed_by` -> `path:codex-rs/core/src/completion_proof.rs`<br>`configuration:reads_config` -> `config:.codex/validation/completion-proof.toml`<br>+8 more | `semantic:canonical-command-gate-separation`<br>`compatibility:immutable-baseline-reconciliation`<br>`compatibility:cross-language-validation-contract-parity` | `completion-proof-source-owner-focused`<br>`completion-proof-runner-focused`<br>`inventory-v2-python-focused`<br>`inventory-v2-rust-focused` |
