...
#[serde(transparent)]
#[ts(export_to = "v2/")]
pub struct RemoteControlEnableResponse(pub RemoteControlStatusChangedNotification);

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, JsonSchema, TS)]
#[serde(transparent)]
#[ts(export_to = "v2/")]
pub struct RemoteControlDisableResponse(pub RemoteControlStatusChangedNotification);

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, JsonSchema, TS)]
#[serde(transparent)]
#[ts(export_to = "v2/")]
pub struct RemoteControlStatusReadResponse(pub RemoteControlStatusChangedNotification);
