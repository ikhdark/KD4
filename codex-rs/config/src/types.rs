...
pub const DEFAULT_MEMORIES_MAX_ROLLOUTS_PER_STARTUP: usize =
    crate::coding_budgets::MEMORY_MAX_ROLLOUTS_PER_STARTUP;
pub const DEFAULT_MEMORIES_MAX_ROLLOUT_AGE_DAYS: i64 =
    crate::coding_budgets::MEMORY_MAX_ROLLOUT_AGE_DAYS;
pub const DEFAULT_MEMORIES_MIN_ROLLOUT_IDLE_HOURS: i64 =
    crate::coding_budgets::MEMORY_MIN_ROLLOUT_IDLE_HOURS;
pub const DEFAULT_MEMORIES_MIN_RATE_LIMIT_REMAINING_PERCENT: i64 =
    crate::coding_budgets::MEMORY_MIN_RATE_LIMIT_REMAINING_PERCENT;
pub const DEFAULT_MEMORIES_MAX_RAW_MEMORIES_FOR_CONSOLIDATION: usize =
    crate::coding_budgets::MEMORY_MAX_RAW_MEMORIES_FOR_CONSOLIDATION;
pub const DEFAULT_MEMORIES_MAX_UNUSED_DAYS: i64 = crate::coding_budgets::MEMORY_MAX_UNUSED_DAYS;
const MIN_MEMORIES_MAX_RAW_MEMORIES_FOR_CONSOLIDATION: usize =
    crate::coding_budgets::MEMORY_MIN_RAW_MEMORIES_FOR_CONSOLIDATION;
const MAX_MEMORIES_MAX_RAW_MEMORIES_FOR_CONSOLIDATION: usize =
    crate::coding_budgets::MEMORY_HARD_MAX_RAW_MEMORIES_FOR_CONSOLIDATION;
const MIN_MEMORIES_MAX_ROLLOUTS_PER_STARTUP: usize =
    crate::coding_budgets::MEMORY_MIN_ROLLOUTS_PER_STARTUP;
const MAX_MEMORIES_MAX_ROLLOUTS_PER_STARTUP: usize =
    crate::coding_budgets::MEMORY_HARD_MAX_ROLLOUTS_PER_STARTUP;
