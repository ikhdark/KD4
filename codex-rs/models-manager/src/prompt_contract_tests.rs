...
const PROMPT_CONTRACTS: &[PromptContract] = &[
    ...
    PromptContract {
        ...
        anchors: &[
            ...
            "report only a material change since the last update",
            "Default to one short sentence per update.",
            "Skip routine edit and test narration, successive passing-test counts, and repeated lists of completed or remaining work.",
            "Combine related findings into one update.",
            "give a brief status without recapping earlier updates",
