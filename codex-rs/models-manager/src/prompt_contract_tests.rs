...
const PROMPT_CONTRACTS: &[PromptContract] = &[
    ...
    PromptContract {
        ...
        anchors: &[
            ...
            "using the original request and corrections rather than only a checklist or inventory profile",
            "Respect explicit user limits",
            "Repair identified omissions using retained evidence and targeted follow-up",
            "without an automatic review loop",
            "report the specific partial, blocked, or unverified result",
        ],
    },
    PromptContract {
        ...
        anchors: &[
            ...
            "Combine related findings; skip routine edit/test narration and repeated plans or lists.",
            "Preserve required updates and disclosures",
            "give a brief status without recapping",
    ...
    PromptContract {
        ...
        anchors: &[
            ...
            "Include all requested material content now rather than deferring it behind follow-up offers or an arbitrary length target.",
            "Treat \"what else?\" as a request for remaining material points within scope.",
            "Respect explicit user limits",
            "do not expand scope to appear exhaustive or remove necessary explanations and caveats.",
            "Explain each material point once at the depth the request or decision needs.",
        ],
    },
    PromptContract {
    ...
    PromptContract {
        ...
        anchors: &[
            ...
            "run an earlier focused check when it changes the next action or prevents costly rework",
    ...
    PromptContract {
        ...
        anchors: &[
            ...
            "Before optional discovery, planning, or validation, identify the unresolved requirement or uncertainty and how the result could change the next action.",
    ...
    PromptContract {
        ...
        anchors: &[
            ...
            "scoped rg searches",
            "Expand only to resolve a material unknown",
    ...
    PromptContract {
        ...
        expectation: AnchorExpectation::All,
        anchors: &[
            "Batch independent calls with bounded tool-native concurrency in one execution",
            ...
            "Return to the model for a new decision or dependency resolution, not between already-planned calls.",
            "Sequence dependent calls after their prerequisites",
            "finishing edits before their checks",
    ...
    PromptContract {
        ...
        anchors: &[
            ...
            "Update affected callers, schemas, duplicate or generated representations, persistence/migrations, compatibility paths, and tests encoding old behavior.",
            ...
            "Prefer the least costly check that proves affected behavior.",
