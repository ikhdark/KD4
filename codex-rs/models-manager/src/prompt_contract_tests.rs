...
const PROMPT_CONTRACTS: &[PromptContract] = &[
    ...
    PromptContract {
        ...
        anchors: &[
            ...
            "Reuse adequate behavioral tests",
            "add or strengthen tests only for material coverage gaps within permitted edit scope",
            "Preserve requested diagnosis; validate related edits in their final state.",
            "Run user-required validation, otherwise nearest sufficient validation",
            "Extra checks must address uncovered requirements.",
