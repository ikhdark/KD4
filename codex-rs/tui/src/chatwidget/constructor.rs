...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            mcp_startup_last_finished_status: HashMap::new(),
            ...
            last_runtime_metrics_refresh: None,
            ...
            status_line_branch_pending_request_id: None,
            status_line_branch_lookup_complete: false,
            status_line_git_summary: None,
            status_line_git_summary_cwd: None,
            status_line_git_summary_pending_request_id: None,
