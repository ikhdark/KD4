...
fn legacy_scope(scope: &ScopeV2) -> Result<LegacyValue, JsonContractError> {
    ...
    Ok(LegacyValue::Object(vec![
        ...
        ("dirty_groups".to_string(), LegacyValue::Object(dirty_groups)),
        (
...
fn legacy_result(result: &FinalizedCommandResult) -> Result<LegacyValue, JsonContractError> {
    ...
    Ok(LegacyValue::Object(vec![
        ...
        ("timed_out".to_string(), LegacyValue::Bool(result.raw.timed_out)),
