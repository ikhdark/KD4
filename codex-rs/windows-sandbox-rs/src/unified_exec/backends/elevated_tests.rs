...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        additional_read_roots: vec![PathBuf::from(
            r"C:\Users\codex\.codex\shell_snapshots\session.ps1",
        )],
    ...
    let expected_refresh = RefreshObservation {
        ...
        additional_read_roots: request.additional_read_roots.clone(),
        read_roots_include_platform_defaults: true,
        ...
        |permissions,
         ...
         proxy_settings_mode| {
            refresh_observations.borrow_mut().push(RefreshObservation {
                ...
                additional_read_roots: additional_read_roots.to_vec(),
                read_roots_include_platform_defaults,
